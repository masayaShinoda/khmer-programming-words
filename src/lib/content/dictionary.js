export const dictionary = {
  ...
  "Argument - អាគុយម៉ង់": [
    "ជាទិន្នន័យឬតម្លៃដែលបញ្ជូលក្នុងអនុគមន៍ដើម្បីធ្វើការគណនា។ ឧទាហរណ៍៖ អនុគមន៍ <code>function add(x, y) {return x + y}</code> ត្រូវការអាគុយម៉ង់ x និង y ដើម្បីគណនារកចម្លើយ។"
  ],
  "Binary - គោលពីរ": [
  ...
  // ],
  "Package - កញ្ចប់កូដ": [
    "ជាកញ្ចប់កូដដែលមានមុខងារពិសេសសម្រាប់បំពេញតួនាទីផ្សេងៗ។ ឧទាហរណ៍៖ កញ្ចប់ <code>requests</code> នៅក្នុងភាសា Python សម្រួលទៅដល់ការផ្ញើសំណើទៅកាន់​ URL ផ្សេងៗ។"
  ],
