export const dictionary = {
  ...
  "E-banking - អ៊ីបេងឃីង": [
    "​ការទូទាត់ធានាគាលើប្រព័ន្ទអ៊ីនធឺណែត។ ឧទាហរណ៍៖ ប្រព័ន្ធបាគង (Bakong App)។"
  ],
  "Encode - អ៊ិនកូដ": [
  ...
  "IP - អាយភី": [
    "លេខសំគាល់ឧបករណ៍ទាំងឡាយដែលអាចភ្ជាប់អ៊ិនធឺណែតបាន។ ឧទាហរណ៍៖ 192.168.0.1"
  ],
  "Network - បណ្ដាញ": [
    "បណ្ដាញភ្ជាប់ទំនាក់ទំនងពីឧបករណ៍មួយទៅឧបកណ៍ច្រើនទៀត។"
  ],
  ...
  "UX/UI - យូអ៊ិច/យូអាយ": [
    "UX សម្ដៅដល់គ្រោងឆ្អឹងប្លង់នៃប្រព័ន្ទកម្មវិធី។ ឧទាហរណ៍៖ កម្មវិធី Microsoft Word មាន menu ខាងលើ ហើយផ្នែកវាយអត្ថបទនៅកណ្ដាល។",
    "UI សម្ដៅដល់រូបរាងពណ៍រូបភាពររចនាលម្អផ្សេងរបស់ប្រព័ន្ធកម្មវិធី។ ឧទាហរណ៍៖ កម្មវិធី Microsoft Word មានពណ៍ទឹកសមុទ្រ រីឯ Microsoft Excel មានពណ៍ត្រួយចេក..។"
  ],
  "Variable - អថេរ": [
