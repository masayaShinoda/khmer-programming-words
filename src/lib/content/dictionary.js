export const dictionary = {
  ...
  "Variable - អថេរ": [
    ...
    "Integer - លេខគត់": [
    "ជាលេខគត់មិនមានក្បៀសអាចជាលេខក្រោមសូន្យរឺលើសូន្យ ស្មើសូន្យ ឧ.ហ៍ ... -2, -1, 0, 1, 2, 3, 4 ... ។ នៅក្នុងប្រព័ន្ទកុំព្យូទ័រ រាល់ទិន្នន័យត្រូវបានបែកចែកច្បាស់លាស់រវាងលេខអត់ក្បៀស លេខមានក្បៀស លេខធំ លេខតូច ដើម្បីអោយកុំព្យូទ័រដំណើរការបានល្អមិនជួបបញ្ហានិងមានភាពសុក្រិត"
  ],
    "Float - លេខទស្សភាគ(លេខមានក្បៀស)": [
    "ជាលេខមានក្បៀសអាចជាលេខក្រោមសូន្យរឺលើសូន្យ ស្មើសូន្យ ឧ.ហ៍ ... -2.10, -103.3, 0, 1.02, 2.3, 35.6, 46.003 ... ។"
  ]
}
